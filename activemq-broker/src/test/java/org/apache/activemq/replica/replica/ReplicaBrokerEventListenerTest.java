...
public class ReplicaBrokerEventListenerTest {
    ...
    private final AbstractRegion abstractRegion = mock(AbstractRegion.class);
    ...
    public void setUp() throws Exception {
        ...
        when(regionBroker.getRegion(any())).thenReturn(abstractRegion);
        when(abstractRegion.getSubscriptions()).thenReturn(Map.of());
    ...
    public void canHandleEventOfType_BATCH() throws Exception {
        ...
        ReplicaEvent sendEvent = new ReplicaEvent()
                .setEventType(ReplicaEventType.MESSAGE_SEND)
                .setEventData(eventSerializer.serializeMessageData(message));
        sendEventMessage.setMessageId(new MessageId("1:1:1:1"));
        ...
        ackEventMessage.setMessageId(new MessageId("1:1:1:2"));
