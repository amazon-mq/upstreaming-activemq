...
public class ReplicaSourceBrokerTest {
    ...
    private final ReplicaReplicationDestinationSupplier queueProvider = new ReplicaReplicationDestinationSupplier(broker);
    ...
    public void setUp() throws Exception {
        ...
        source = new ReplicaSourceBroker(broker, null, replicaEventReplicator, replicaSequencer, queueProvider, null, replicaPolicy);
    ...
    public void createsQueueOnInitialization() throws Exception {
        source.start(ReplicaRole.source, false);
