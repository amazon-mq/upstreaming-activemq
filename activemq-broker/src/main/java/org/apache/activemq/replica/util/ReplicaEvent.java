...
public class ReplicaEvent {
    ...
    public ReplicaEvent setTransactionId(TransactionId transactionId) {
    ...
    public ReplicaEvent setReplicationProperty(String propertyKey, Object propertyValue) {
    ...
    public ReplicaEvent setVersion(int version) {
        this.version = version;
        return this;
    }

    public ReplicaEvent setTimestamp(long timestamp) {
