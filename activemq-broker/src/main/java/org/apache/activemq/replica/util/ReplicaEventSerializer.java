...
public class ReplicaEventSerializer {
    ...
    public Object deserializeMessageData(ByteSequence sequence) throws IOException {
        return wireFormat.unmarshal(sequence);
    }

    public byte[] serializeListOfObjects(List<DataStructure> list) throws IOException {
    ...
    public List<Object> deserializeListOfObjects(byte[] bytes) throws IOException {
