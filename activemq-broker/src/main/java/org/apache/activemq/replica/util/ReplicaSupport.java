...
public class ReplicaSupport {
    ...
    public static final String REPLICATION_RESYNCHRONIZATION_QUEUE_NAME = REPLICATION_QUEUE_PREFIX + "Resynchronization.Queue";
    ...
    public static final Set<String> DELETABLE_REPLICATION_DESTINATION_NAMES = Set.of(MAIN_REPLICATION_QUEUE_NAME,
            INTERMEDIATE_REPLICATION_QUEUE_NAME, SEQUENCE_REPLICATION_QUEUE_NAME, REPLICATION_RESYNCHRONIZATION_QUEUE_NAME);
